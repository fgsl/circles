OC.L10N.register(
    "circles",
    {
    "Circles is using its own way to async heavy process." : "O círculo usa sua própria maneira para processos pesados assíncronos.",
    ...
    "Anyone can find and request an invitation to the circle; but only members will see who\\'s in it and get access to it\\'s shared items." : "Qualquer um pode procurar e solicitar um convite para um círculo mas apenas os membros verão quem está nele e terão acesso aos seus itens compartilhados.",
    ...
    "Async Testing:" : "Teste Assíncrono:",
    "initiate async test in Circles" : "iniciar um teste assíncrono nos Círculos",
    "reset test result" : "redefinir resultado do teste",
    "Test underway. Please wait." : "Teste em andamento. Por favor, espere.",
